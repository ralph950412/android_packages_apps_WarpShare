...
public final class CustomTrust {
    ...
    public CustomTrust() {
        ...
        try {
            ...
            sslContext.init(
                    keyAndTrustManagers.keyManagers, keyAndTrustManagers.trustManagers, null);
    ...
    public void run() throws Exception {
        Request request =
                new Request.Builder().url("https://publicobject.com/helloworld.txt").build();
    ...
    private InputStream trustedCertificatesInputStream() {
        // PEM files for root certificates of Comodo and Entrust. These two CAs are sufficient to
        // view
        // https://publicobject.com (Comodo) and https://squareup.com (Entrust). But they aren't
        // sufficient to connect to most HTTPS sites including https://godaddy.com and
        // https://visa.com.
        // Typically developers will need to get a PEM file from their organization's TLS
        // administrator.
     ...
     * custom set. This is useful in development where certificate authority-trusted certificates
     * aren't available. Or in production, to avoid reliance on third-party certificate authorities.
     *
     ...
     * additional operational complexity and limit your ability to migrate between certificate
     * authorities. Do not use custom trusted certificates in production without the blessing of
